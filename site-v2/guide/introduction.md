...
await sdk.kline.cn('600519', { period: 'day' }) // A 股历史 K 线
...
- 金额 / 价格为**各市场计价货币的主单位**（A 股=人民币元 / 港股=港元 / 美股=美元，不跨币种折算），成交量目标口径为「股」。
...
| 选股回测 | `sdk.screener()` / `stock-sdk/screener` | 声明式选股器、本地回测引擎 |
