...
| 分钟 K 线（5/15/30/60） | ✅ | ❌ | ❌ | ⚠️ 场内 ETF/LOF（走 `getMinuteKline`） | ❌ | ❌ |
| 当日分时（1 分钟） | ✅ | ❌ | ❌ | ⚠️ 场内 ETF/LOF | ❌ | ✅ ETF 期权 |
| **历史净值（单位/累计）** | — | — | — | ✅ 全历史（`getFundNavHistory`） | — | — |
| **实时估值（盘中刷新）** | — | — | — | ✅ `getFundEstimate` | — | — |
| **同类排名走势** | — | — | — | ✅ `getFundRankHistory` | — | — |
